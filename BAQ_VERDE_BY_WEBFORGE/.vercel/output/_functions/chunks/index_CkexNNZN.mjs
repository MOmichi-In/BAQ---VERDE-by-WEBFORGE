import {
    B as decryptString,
    C as createSlotValueFromString,
    G as isAstroComponentFactory,
    k as renderComponent,
    r as renderTemplate,
    q as REROUTE_DIRECTIVE_HEADER,
    A as AstroError,
    H as i18nNoLocaleFoundInPath,
    J as ResponseSentError,
    ...
    a2 as MiddlewareNoDataOrNextCalled,
    a3 as MiddlewareNotAResponse,
    a4 as SessionStorageInitError,
    a5 as SessionStorageSaveError,
    R as ROUTE_TYPE_HEADER,
    a6 as ForbiddenRewrite,
    a7 as ASTRO_VERSION,
    a8 as CspNotEnabled,
    a9 as LocalsReassigned,
    aa as generateCspDigest,
    ab as PrerenderClientAddressNotAvailable,
    w as clientAddressSymbol,
...
} from "./astro/server_Dm-8eCho.mjs";
...
} from "./astro-designed-error-pages_CxjKz-E7.mjs";
        ...
        if (firstResult && firstResult.locale !== "*") {
            for (const currentLocale of locales) {
                if (typeof currentLocale === "string") {
                    if (
                        normalizeTheLocale(currentLocale) === normalizeTheLocale(firstResult.locale)
                    ) {
...
class Slots {
    ...
    async render(name, args = []) {
        ...
        if (!Array.isArray(args)) {
            ...
            const component =
                typeof slotValue === "function" ? await slotValue(result) : await slotValue;
...
class RenderContext {
    ...
    async createResult(mod, ctx) {
        ...
        const result = {
            ...
            cspDestination:
                manifest.csp?.cspDestination ?? (routeData.prerender ? "meta" : "header"),
            shouldInjectCspMetaTags,
            cspAlgorithm,
