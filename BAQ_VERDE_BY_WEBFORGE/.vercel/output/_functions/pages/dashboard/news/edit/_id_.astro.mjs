...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$DashboardLayout, { "title": "Editar Noticia", "data-astro-cid-adzo4iv4": true }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="dashboard-container" data-astro-cid-adzo4iv4> <!-- Header Section --> <div class="dashboard-header" data-astro-cid-adzo4iv4> <div class="header-content" data-astro-cid-adzo4iv4> <div class="title-section" data-astro-cid-adzo4iv4> <h1 class="dashboard-title" data-astro-cid-adzo4iv4>✏️ Editar Noticia</h1> <p class="dashboard-subtitle" data-astro-cid-adzo4iv4>Modifica los datos de la publicación seleccionada</p> </div> <div class="header-actions" data-astro-cid-adzo4iv4> <a href="/dashboard/news" class="btn-back" data-astro-cid-adzo4iv4> <span class="btn-icon" data-astro-cid-adzo4iv4>⬅️</span>
Volver al Panel
...
}, "/Users/iamxfree/Documents/WEBFORGE/DAIRON/BAQVERDE/BAQ_VERDE_BY_WEBFORGE/src/pages/dashboard/news/edit/[id].astro", void 0);
const $$file = "/Users/iamxfree/Documents/WEBFORGE/DAIRON/BAQVERDE/BAQ_VERDE_BY_WEBFORGE/src/pages/dashboard/news/edit/[id].astro";
