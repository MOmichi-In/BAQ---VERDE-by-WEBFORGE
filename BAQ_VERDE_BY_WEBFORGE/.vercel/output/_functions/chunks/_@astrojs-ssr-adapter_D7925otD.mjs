    ...
    async render(request, renderOptions) {
        ...
        if (!routeData) {
            routeData = this.#manifestData.routes.find(
                (route) =>
                    route.component === "404.astro" || route.component === DEFAULT_404_COMPONENT
            );
        }
        if (!routeData) {
...
class NodeApp extends App {
    ...
    static createRequest(req, { skipBody = false } = {}) {
        ...
        const bodyAllowed =
            options.method !== "HEAD" && options.method !== "GET" && skipBody === false;
        if (bodyAllowed) {
