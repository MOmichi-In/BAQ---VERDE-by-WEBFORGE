...
Eliminar
                    ...
                    noticias.length === 0 &&
                    renderTemplate`<div class="empty-state" data-astro-cid-ji6rsa6m> <div class="empty-icon" data-astro-cid-ji6rsa6m>🤝</div> <h3 class="empty-title" data-astro-cid-ji6rsa6m>No hay participaciones registradas</h3> <p class="empty-description" data-astro-cid-ji6rsa6m>Comienza creando la primera participación ciudadana</p> <a href="/dashboard/stake/create" class="btn-empty-action" data-astro-cid-ji6rsa6m> <span class="btn-icon" data-astro-cid-ji6rsa6m>+</span>
Crear Primera Participación
</a> </div>`
                } </div> </div> </div>  ${renderScript($$result2, "/Users/iamxfree/Documents/WEBFORGE/DAIRON/BAQVERDE/BAQ_VERDE_BY_WEBFORGE/src/pages/dashboard/stake/index.astro?astro&type=script&index=0&lang.ts")} `,
            }
        )}`;
    },
