...
const $$Index = createComponent(
    ($$result, $$props, $$slots) => {
        ...
        return renderTemplate`${renderComponent(
            ...
            "Layout",
            $$DashboardLayout,
            { title: "Panel de Administraci\xF3n", "data-astro-cid-y55gmoyq": true },
            {
                default: (
                    $$result2
                ) => renderTemplate`  ${maybeRenderHead()}<div class="dashboard-container" data-astro-cid-y55gmoyq> <section class="welcome-section" data-astro-cid-y55gmoyq> <div class="welcome-content" data-astro-cid-y55gmoyq> <h2 data-astro-cid-y55gmoyq>Panel de Administración</h2> <p data-astro-cid-y55gmoyq>
