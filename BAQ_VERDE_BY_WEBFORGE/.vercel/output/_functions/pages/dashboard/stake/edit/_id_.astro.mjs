import { e as createComponent, f as createAstro, k as renderComponent, r as renderTemplate, m as maybeRenderHead, h as addAttribute, l as renderScript } from '../../../../chunks/astro/server_Dm-8eCho.mjs';
import 'kleur/colors';
...
</label> <input type="text" id="title" name="title" class="form-input"${addAttribute(participacion.title, "value")} placeholder="Ingresa el título de la participación..." required data-astro-cid-xuqton2o> </div> <!-- Imagen Actual --> ${participacion.img_url && renderTemplate`<div class="form-group" data-astro-cid-xuqton2o> <label class="form-label" data-astro-cid-xuqton2o> <span class="label-icon" data-astro-cid-xuqton2o>🖼️</span>
Imagen Actual
</label> <div class="current-image-preview" data-astro-cid-xuqton2o> <img${addAttribute(`${"http://localhost:8000"}${participacion.img_url}`, "src")} alt="Imagen actual" class="preview-img-tag" data-astro-cid-xuqton2o> </div> </div>`} <!-- Nueva Imagen (opcional) --> <div class="form-group" data-astro-cid-xuqton2o> <label for="image" class="form-label" data-astro-cid-xuqton2o> <span class="label-icon" data-astro-cid-xuqton2o>📁</span>
...
}, "/Users/iamxfree/Documents/WEBFORGE/DAIRON/BAQVERDE/BAQ_VERDE_BY_WEBFORGE/src/pages/dashboard/stake/edit/[id].astro", void 0);
const $$file = "/Users/iamxfree/Documents/WEBFORGE/DAIRON/BAQVERDE/BAQ_VERDE_BY_WEBFORGE/src/pages/dashboard/stake/edit/[id].astro";
